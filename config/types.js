...
export const MACVLAN = {
  SUBNET: 'macvlan.cluster.cattle.io.macvlansubnet',
}

export const REDIS = 'redis'

export const REDIS_TYPES = {
  CLUSTERED_REDIS: 'redis.cattle.io.clusteredredis', 
  REDIS:           'redis.cattle.io.redis', 
}

export const REDIS_AUDIT_TYPES = {
  CLUSTERED_REDIS: 'redis.cattle.io.clusteredredisaudit', 
  REDIS:           'redis.cattle.io.redisaudit', 
  BACKUP:          'redis.cattle.io.backupaudit'
}